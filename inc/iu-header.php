<header id="header">
    ...
    <div id="branding-bar" class="iub" itemscope="itemscope" itemtype="http://schema.org/CollegeOrUniversity">
        <div class="row pad">
            ...
            <p id="iu-campus">
                <a href="https://bloomington.iu.edu/index.html" title="Indiana University Bloomington" class="external">
    ...
    <div id="offCanvas" class="hide-for-large" role="navigation" aria-label="Mobile">
        <button class="menu-toggle button hide-for-large" data-toggle="iu-menu" aria-expanded="false" aria-controls="iu-menu" aria-label="Open Menu">Menu</button>
